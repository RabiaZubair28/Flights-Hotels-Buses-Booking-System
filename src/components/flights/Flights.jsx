            ...
            <div className="relative">
                ...
                <div className="container position-absolute top-60 start-50 translate-middle">
                    <Row
                        ...
                        md={4}
                        lg={4}
                        className="mb-3 other_parameters">
                        <Col>
                            <select>
                                <option value="">
                                    <span
                        ...
                        <Col>
                            <div className="travlers">
                                ...
                                <div
                                    className="block mt-4 rounded shadow"
                                    style={{
                                        display: isTravelersVisible
                                            ? 'block'
                                            : 'none',
                                    }}>
                                        ...
                                        <div className="col-lg-6 ps-4">
                                            <p>
                                                <svg
                                                    ...
                                                    fill="#f5b342"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    class="_1MZrIK28AE8HVj289UBgZw st-svg-icon me-2">
